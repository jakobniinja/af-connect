...
module.exports = {
  ...
  portabilityUrl: process.env.PORTABILITY_URL || 'https://portabilitystage.arbetsformedlingen.se/portability-api',
  portabilityHost: process.env.PORTABILITY_HOST || 'portabilitystage.arbetsformedlingen.se',
